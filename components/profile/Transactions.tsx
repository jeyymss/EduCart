        ...
        data={
          selectedTx
            ? {
                ...
                service_fee: (selectedTx as any).service_fee,
                items_total: (selectedTx as any).items_total,
                cash_added: (selectedTx as any).cash_added,
                rent_days: (selectedTx as any).rent_days,
                rent_start_date: (selectedTx as any).rent_start_date,
                rent_end_date: (selectedTx as any).rent_end_date,
                pasabuy_items: (selectedTx as any).pasabuy_items,
                payment_method: selectedTx.payment_method,
                method: selectedTx.method,
                type: selectedTx.type,
                post_type: selectedTx.post_type,
