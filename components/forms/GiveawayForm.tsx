...
export function GiveawayForm({ selectedType }: FormProps) {
  ...
  return (
    <div className="w-full">
      {/* Info Alert */}
      <div className="flex items-start gap-3 bg-pink-50 border border-pink-200 rounded-lg p-4 mb-6">
        ...
        <div className="space-y-5">
          ...
          <div>
            <Label className="text-sm font-medium text-gray-700">
              What are you giving away? <span className="text-red-600">*</span>
            </Label>
            <Input
              type="text"
              name="itemTitle"
              placeholder="e.g., Study Desk, Textbooks, Clothing"
              className="mt-1.5 border-gray-300 focus:border-pink-400 focus:ring-pink-400"
              required
            />
          </div>
          ...
          <div>
            ...
            <textarea
              placeholder="Describe the item's condition, size, color, and any other relevant details. Include pickup/meetup instructions..."
          ...
          {/* Condition and Category - Grid Layout */}
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <Select onValueChange={setCondition}>
                <SelectTrigger className="w-full mt-1.5 border-gray-300 focus:border-pink-400 focus:ring-pink-400">
          ...
          className={`
            ...
            ${
              isFormValid && !loading && !isLoading
                ? "bg-pink-500 text-white hover:bg-pink-600 hover:shadow-lg transform hover:-translate-y-0.5"
