    ...
    <div className="min-h-screen flex justify-center items-center">
      <div className="flex flex-col gap-4">
        ...
        <div className="space-y-2">
          ...
          {/* Only show status if you actually store it somewhere.
             Remove this block or set a placeholder if not in your schema. */}
          {/* <p><strong>Status:</strong> {user.verification_status ?? "Pending"}</p> */}
